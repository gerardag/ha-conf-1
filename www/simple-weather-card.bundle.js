! function (A) {
    ...
    t.m = A, t.c = e, t.d = function (A, e, n) {
        ...
        if (t.r(n), Object.defineProperty(n, "default", {
            ...
            for (var i in A) t.d(n, i, function (e) {
                return A[e]
            }.bind(null, i));
        return n
    }, t.n = function (A) {
    ...
    const c = window.LitElement || Object.getPrototypeOf(customElements.get("home-assistant-main")),
        {
            html: u,
            css: D
        } = c.prototype,
    ...
    customElements.define("simple-weather-card", class extends c {
        ...
        set hass(A) {
            this._hass = A;
            const e = A.states[this.config.entity];
            e && this.entity !== e && (this.entity = e, this.weather = new n.default(A, e))
        }
        get hass() {
            return this._hass
        }
        ...
        setConfig(A) {
            if (!A.entity) throw new Error("Specify an entity.");
            this.config = {
                bg: !!A.backdrop,
        ...
        render() {
            return u(s(), this.config.bg, this.config.backdrop.fade, this.weather.isNight, this.config.backdrop.day, this.config.backdrop.night, this.config.backdrop.text, () => this.moreInfo(), this.renderIcon(), this.weather.temp, this.getUnit(), this.name, this.weather.state, this.renderExtrema(this.weather.high, this.weather.low), this.renderSecondaryInfo(this.config.secondary_info))
        }
        renderIcon() {
            return this.weather.hasState ? u(a(), this.weather.icon) : ""
        }
        renderExtrema(A, e) {
            return A || e ? u(r(), A ? A + this.getUnit() : "", A && e ? " / " : "", e ? e + this.getUnit() : "") : ""
        }
        renderSecondaryInfo(A) {
            return u(M(), this.weather.getIcon(f[A].icon), this.weather[A], this.getUnit(f[A].unit))
        }
        moreInfo() {
            const A = new Event("hass-more-info", {
                composed: !0
            });
            A.detail = {
        ...
        getUnit(A = "temperature") {
            const e = "speed" === A ? "length" : A,
                t = this.hass.config.unit_system[e];
            return "temperature" === A ? t || w.celsius : "length" === A ? "km" === t ? "mm" : "in" : "speed" === A ? t ? "".concat(t, "/h") : "km/h" : A
        }
    })
}, function (A, e, t) {
    "use strict";
    ...
    const h = {
            "clear-night": n.default,
            cloudy: i.default,
            overcast: i.default,
            fog: g.default,
            hail: w.default,
            lightning: M.default,
            "lightning-rainy": r.default,
            partlycloudy: s.default,
            pouring: c.default,
            rainy: u.default,
            snowy: D.default,
            "snowy-rainy": w.default,
            sunny: f.default,
            windy: E.default,
            "windy-variant": E.default,
            humidity: j.default
        },
        y = {
            ...h,
            sunny: n.default,
            partlycloudy: o.default,
            "lightning-rainy": a.default
        };
    e.default = class {
        constructor(A, e) {
            this.hass = A, this.entity = e, this.attr = e.attributes, this.forecast = e.attributes.forecast || [
                []
            ]
        }
        get state() {
        ...
        get hasState() {
            return this.entity.state && "unknown" !== this.entity.state
        }
        get temp() {
